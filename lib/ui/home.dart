...
class _HomeState extends State<Home> {
 ...
 final response=await http.get('http://192.168.43.132:8080/rest_apici/index.php/penjualan/');
...
onTap: () =>Navigator.of(context).pushReplacement( new 
   ...
   Future<http.Response> deletePenjualan(id) async { 
    final http.Response response = await http.delete(
      'http://192.168.43.132:8080/rest_apici/index.php/penjualan/delete/$id'); 
    return response;
}
